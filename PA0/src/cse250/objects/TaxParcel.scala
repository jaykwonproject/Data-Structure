...
class TaxParcel {
  val parcelInfo: Map[String, String] = new HashMap[String, String]  //pacrcelinfo는 해쉬맵이다
  ...
  override def hashCode: Int = {
    parcelInfo.hashCode   //It returns an integer hash code of the string given. 얘는 그냥 스트링에 숫자코드를 줌 아마도 숫자코드로 비교하나봄
  }
}
